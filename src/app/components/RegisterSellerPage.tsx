  ...
  return (
    <div className="app-page">
      <div className="app-shell py-12">
        <h1 className="text-3xl font-mono text-gray-900 mb-8">Register as Seller</h1>
        ...
        <div className="max-w-2xl mx-auto bg-white border border-gray-300 p-8">
          <form className="space-y-6">
            ...
            <div>
              <label className="block font-mono text-sm text-gray-700 mb-2">Warehouse Location</label>
              <input type="text" className="w-full border border-gray-300 p-3 font-mono text-sm" />
            </div>

            <div>
              <label className="block font-mono text-sm text-gray-700 mb-2">Commodity Types</label>
